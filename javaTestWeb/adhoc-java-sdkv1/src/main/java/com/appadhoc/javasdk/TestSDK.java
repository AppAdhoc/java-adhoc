...
public class TestSDK {
    ...
    public static void main(String[] args) {
        ...
        AdhocSdk.getInstance().incrementStat(client_id, "Payment", "1");
        AdhocSdk.getInstance().incrementStat(client_id, "Payment", 1);
        AdhocSdk.getInstance().incrementStat(client_id, "Payment", 1l);
        AdhocSdk.getInstance().incrementStat(client_id, "Payment", 1.0f);
        AdhocSdk.getInstance().incrementStat(client_id, "Payment", 1.0d);
    }
}
